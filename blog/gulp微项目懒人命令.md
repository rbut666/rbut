---
title: 一条命令创建一个简单的gulp 文件部署
date: 2018-06-02 12:04:53
tags: gulp
---
...
``` bash
# 创建必须的文件和目录
touch gulpfile.js && touch index.html && mkdir less && mkdir js && cd less && touch index.less && cd ../js && touch index.js && cd ../ && npm init -y
# 安装基础包
